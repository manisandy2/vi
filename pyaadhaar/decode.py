...
class AadhaarOfflineXML:
    ...
    def __init__(self,decodeStr:str = None, file:str = None, passcode:str = None) -> None:
        ...
        if decodeStr:
            parsedxml = ET.fromstring(
                decodeStr, parser=ET.XMLParser(encoding="utf-8"))
        else :
...
class AadhaarQRXML:
    ...
    def __init__(self,decodeStr:str = None) -> None:
        # Need to pass the zip file and passcode/sharecode to this function
        
        self.data = {}
        parsedxml = ET.fromstring(decodeStr, parser=ET.XMLParser(encoding="utf-8"))
        self.root = parsedxml

        self.data['referenceid'] = self.root.attrib['uid']
        self.data['name'] = self.root.attrib['name']
        self.data['dob'] = self.root.attrib['dob']
        self.data['gender'] = self.root.attrib['gender']
        self.data['careof'] = self.root.attrib['co']
        self.data['district'] = self.root.attrib['dist']
        self.data['house'] = self.root.attrib['house']
        self.data['location'] = None
        self.data['pincode'] = self.root.attrib['pc']
        self.data['postoffice'] = self.root.attrib['po']
        self.data['subdistrict'] = self.root.attrib['subdist']
        self.data['state'] = self.root.attrib['state']
        self.data['street'] = self.root.attrib['street']
        self.data['vtc'] = self.root.attrib['vtc']
        self.data['aadhaar_last_4_digit'] = None
        self.data['aadhaar_last_digit'] = None
